...
int fpga_link1::Encoder(Command& cmd, SerializedCommand* serialized) {
      ...
      printf("Non-encoded Frame: 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X\n",
             tmp[0],
             tmp[1],
             tmp[2],
             tmp[3],
      ...
      printf("Encoded Frame    : 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X 0x%02X\n",
             serialized->data[0],
             serialized->data[1],
             serialized->data[2],
             serialized->data[3],
